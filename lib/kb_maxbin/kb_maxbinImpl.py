...
class kb_maxbin:
    ...
    GIT_COMMIT_HASH = "d2c2a8f04c6127cb71761e6073f35e6cfec1e822"
    ...
    def run_max_bin(self, ctx, params):
        ...
        :param params: instance of type "MaxBinInputParams" (required params:
           ...
           parameter "prob_threshold" of Double, parameter "markerset" of
           Long, parameter "min_contig_length" of Long, parameter
