...
function kb_maxbin(url, auth, auth_cb, timeout, async_job_check_time_ms, service_version) {
    var self = this;
    ...
    var _auth_cb = auth_cb;
     ...
     this.run_max_bin = function (params, _callback, _errorCallback) {
        ...
        return json_call_ajax(_url, "kb_maxbin.run_max_bin",
    ...
    this.status = function (_callback, _errorCallback) {
        ...
        return json_call_ajax(_url, "kb_maxbin.status",
